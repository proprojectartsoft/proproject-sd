                        ...
                        service.getme()
                            .success(function(data) {
                                ...
                                function getAllSettings(callback) {
                                    ...
                                    var staffReq = getFromServer('staff', 'staff')
                                    var unitReq = getFromServer('unit', 'units');
                                    var settingsReq = getFromServer('companysettings', null, function(data) {
                        ...
                        service.getProjects(function(projects) {
                            ...
                            if (sessionStorage.getObject('sd.diary.shares')) {
                                ...
                                for (var a = 0; a < shares.length; a++) {
                                    PostService.post({
                                        url: 'sharesitediary ? siteDiaryId = ' + shares[a].id + ' & email = ' + shares[a].res,
                                        method: 'POST',
                                        data: {}
