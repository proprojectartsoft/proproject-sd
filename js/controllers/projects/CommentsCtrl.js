...
CommentsCtrl.$inject = ['$rootScope', '$state', '$stateParams', '$filter', 'SiteDiaryService', 'ProjectService', 'SyncService', 'orderByFilter', '$ionicPopup', 'SettingService', 'ColorService'];

function CommentsCtrl($rootScope, $state, $stateParams, $filter, SiteDiaryService, ProjectService, SyncService, orderBy, $ionicPopup, SettingService, ColorService) {
    var vm = this;
    vm.go = go;
