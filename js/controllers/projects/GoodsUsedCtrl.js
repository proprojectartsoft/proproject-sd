...
GoodsUsedCtrl.$inject = ['$state', '$rootScope', '$stateParams', 'SiteDiaryService', 'SettingService'];

function GoodsUsedCtrl($state, $rootScope, $stateParams, SiteDiaryService, SettingService) {
	var vm = this;
	vm.go = go;
