...
OhsCtrl.$inject = ['$state', '$stateParams', '$scope', 'SettingService', 'SiteDiaryService', '$rootScope'];

function OhsCtrl($state, $stateParams, $scope, SettingService, SiteDiaryService, $rootScope) {
	var vm = this;
	vm.go = go;
