...
IncidentsCtrl.$inject = ['$scope', '$state', '$ionicModal', '$stateParams', 'SiteDiaryService', 'SettingService', 'SyncService', '$rootScope'];

function IncidentsCtrl($scope, $state, $ionicModal, $stateParams, SiteDiaryService, SettingService, SyncService, $rootScope) {
    var vm = this;
